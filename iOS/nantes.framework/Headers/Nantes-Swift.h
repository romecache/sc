...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Nantes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Nantes11NantesLabel")
@interface NantesLabel : UILabel
...
/// The shadow color for the label when the label’s <code>highlighted</code> property is true. Defaults to nil
@property (nonatomic, strong) UIColor * _Nullable highlightedShadowColor;
/// The shadow offset for the label when the label’s <code>highlighted</code> propert is true. A value of 0 indicates no blur, larger numbers indicate more blur. This can’t be a negative value.
...
@property (nonatomic) CGFloat highlightedShadowRadius;
...
/// The maximum line height within the paragraph. If the value is 0.0, the maximum line height is set to the line height of the <code>font</code>. 0.0 by default
@property (nonatomic) CGFloat maximumLineHeight;
/// The minimum line height within the paragraph. If the value is 0.0, the minimum line height is set to the line height of the <code>font</code>. 0.0 by default
...
/// It’s important to set <code>attributedText</code> or <code>text</code> before adding links
...
@interface NantesLabel (SWIFT_EXTENSION(Nantes))
